...
- Design references: `docs/design/design.md` (visual SSOT — BQ-21); `docs/design/resources/screenshots/expanded-card-spec.png` (interpretation aid). Historical evidence only, superseded per BQ-21 and relocated under `docs/design/resources/superseded/` — **not** current visual authority: `wave4-expanded-test-content-reference.css`, `wave5-expanded-test-visual-skin-reference.css`.
