...
| 산출물 | 내용 |
|---|---|
| `VariantRegistry` 타입 | `variant-registry.generated.json`의 스키마. `VariantSchema[]`,`LandingCardMeta[]`(`cardType` 5종 포함. `unavailable: boolean` 레거시 필드 호환 처리 포함) 포함. 상세 타입 계약: `docs/req-test.md` §2.5 |
